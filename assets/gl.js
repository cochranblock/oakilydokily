...
"use strict";
// miniquad gl.js v2 (from miniquad 0.4.8 crate)
const version = 2;
...
if (!canvas) {
    console.error("gl.js: #glcanvas not found. Ensure <canvas id=\"glcanvas\"> exists before loading gl.js.");
    throw new Error("gl.js: #glcanvas not found");
}
canvas.focus();
